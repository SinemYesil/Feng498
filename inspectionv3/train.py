...
# Paths
base_path = "/Users/ceren/PycharmProjects/Feng498/dataset/augmented_train"
output_dir = "/Users/ceren/PycharmProjects/Feng498/inspectionv3/outputs"
...
for fold, (train_idx, val_idx) in enumerate(skf.split(np.zeros(len(targets)), targets)):
    ...
    model.AuxLogits.fc = nn.Linear(model.AuxLogits.fc.in_features, len(class_map))
    model.to(device)
